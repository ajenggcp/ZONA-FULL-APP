<nav x-data="{ open: false }" class="border-b border-gray-100 nav-menu" style="background-color: #37517e;">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <h1 class="logo mr-auto" style="font-family: 'Jost', sans-serif;"><a href="/dashboard">
                            ZONA
                        </a></h1>
                </div>
